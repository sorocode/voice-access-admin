  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Button className="bg-blue-600 hover:bg-blue-700" onClick={handleNewMember}>
        ...
        <CardContent>
          {isLoading ? (
            <div className="flex justify-center items-center py-10">
              ...
              <span className="ml-2 text-gray-600">회원 정보를 불러오는 중...</span>
            </div>
          ) : (
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left py-3 px-4 font-medium text-gray-600">전화번호</th>
                    <th className="text-left py-3 px-4 font-medium text-gray-600">주소</th>
                    <th className="text-left py-3 px-4 font-medium text-gray-600">몸무게</th>
                    <th className="text-left py-3 px-4 font-medium text-gray-600">키</th>
                    <th className="text-left py-3 px-4 font-medium text-gray-600">가입일</th>
                    <th className="text-left py-3 px-4 font-medium text-gray-600">최근 출입</th>
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                              <span className="text-sm font-medium text-blue-600">{member.name?.[0] || "?"}</span>
                            </div>
                            <span className="font-medium">{member.name}</span>
                          </div>
                        </td>
                        <td className="py-4 px-4 text-gray-600">{member.phoneNumber}</td>
                        <td className="py-4 px-4 text-gray-600">{member.address || "-"}</td>
                        <td className="py-4 px-4 text-gray-600">{member.weight || "-"}</td>
                        <td className="py-4 px-4 text-gray-600">{member.height || "-"}</td>
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="weight" value={formData.weight} onChange={handleInputChange} className="col-span-3" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
              <Label htmlFor="height" className="text-right">
                키
              </Label>
              <Input id="height" value={formData.height} onChange={handleInputChange} className="col-span-3" />
            </div>
